...
quantumart-protocol-2026-official
  └── defines principles, ethics, terminology, and publication structure
...
The canonical repository defines the principles. This repository tests one possible implementation.
...
- preserve a public record of the experiment
- test interaction patterns derived from the QuantumArt Protocol
- make uncertainty visible through an aesthetic interface
- separate poetic metaphor from scientific claims
- document provenance before external publication or minting
